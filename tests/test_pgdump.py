...
def test_dump_file_name_with_timestamp():
    """
    pgdump.dump_file_name returns the name of the database with timestamp append
    """
    timestamp = "2019-03-16T20:15"
    assert pgdump.dump_file_name(url, timestamp) == "db_one-2019-03-16T20:15.sql"
